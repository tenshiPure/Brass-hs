...
getAdminInitR = do
    ...
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 1 :: GroupId) (toSqlKey 1 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 1 :: GroupId) (toSqlKey 2 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea shortBody) now (toSqlKey 1 :: GroupId) (toSqlKey 2 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 1 :: GroupId) (toSqlKey 3 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea shortBody) now (toSqlKey 1 :: GroupId) (toSqlKey 4 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea shortBody) now (toSqlKey 1 :: GroupId) (toSqlKey 5 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 1 :: GroupId) (toSqlKey 6 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 1 :: GroupId) (toSqlKey 6 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea longBody)  now (toSqlKey 3 :: GroupId) (toSqlKey 1 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea shortBody) now (toSqlKey 7 :: GroupId) (toSqlKey 1 :: PersonId)
    _ <- runDB $ insert $ Message (Textarea shortBody) now (toSqlKey 7 :: GroupId) (toSqlKey 4 :: PersonId)
