...
getAdminInitR = do
    ...
    _ <- runDB $ insert $ GroupLog "東京シティブラスオルケスター" "tcbo.jpg" 0 created (toSqlKey 1 :: GroupId) (toSqlKey 1 :: PersonId)
    ...
    createBelong (toSqlKey  1 :: GroupId) (toSqlKey 7 :: PersonId)
    deleteBelong (toSqlKey  1 :: GroupId) (toSqlKey 7 :: PersonId)
...
getAdminWorkspaceR :: Handler TypedContent
getAdminWorkspaceR = selectRep $ do
    provideRep $ return
        [shamlet|
